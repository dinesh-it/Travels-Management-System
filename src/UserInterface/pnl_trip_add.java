...
public class pnl_trip_add extends JPanel {
	...
	public pnl_trip_add() {
		...
		JComboBox cmb_circle = new JComboBox();
		lbl_circle.setLabelFor(cmb_circle);
		cmb_circle.setModel(new DefaultComboBoxModel(new String[] {"Local", "Outstation"}));
		...
		JComboBox cmb_cust_slab = new JComboBox();
		...
		JComboBox cmb_trvl_slab = new JComboBox();
